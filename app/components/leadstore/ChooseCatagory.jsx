...
const CATEGORIES = [
  ...
  { id: 7, title: "HNI (High Net Worth Individuals) Data", slug: "hni-high-net-worth-individuals-data", icon: Crown },
  ...
  { id: 11, title: "Company's,Hotel, Collage School, Resturents, Spa Database", slug: "companys-hotel-collage-school-resturents-spa-database", icon: Building },
    ...
    <>
      ...
      >
        <div className="flex flex-row justify-between items-center w-full px-4 sm:px-8 md:px-8 lg:px-6 bg-white gap-2">
          <div className="text-lg sm:text-xl md:text-2xl font-bold">Shop by Categories</div>
          <div
