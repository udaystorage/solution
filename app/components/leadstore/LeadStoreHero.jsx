...
export default function LeadStoreHero() {
  return (
    <section className="relative isolate overflow-hidden w-screen h-150 sm:h-180 md:h-160  flex flex-col md:flex-row justify-center items-center pt-24 md:pt-15 lg:pt-18 px-6 md:px-0 gap-10 md:gap-0 pb-10 md:pb-0">
      {/* Base Gradient */}
