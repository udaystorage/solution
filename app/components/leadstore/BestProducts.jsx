...
const CATEGORIES = [
  ...
  {
    id: 11,
    title: "Company's,Hotel, Collage School Database",
    slug: "companys-hotel-collage-school-database"
  },
  {
    id: 12,
...
export default function BestProducts() {
    return (
      <>
        <div
          className={`w-full  flex flex-col justify-start items-center overflow-hidden transition-all duration-400`}
        >
          <div className="flex flex-row justify-between items-center w-full px-25 py-5 bg-white">
            <div className="text-2xl font-bold py-3">Best Selling Products</div>
            {/* <div
          ...
          <div className="flex flex-row justify-center items-start flex-wrap gap-12 w-full px-20">
