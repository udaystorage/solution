...
const handleWhyChooseUsClick = () => {
  ...
  return (
    ...
    <section className="w-full px-4 py-16 sm:px-8 md:px-16 lg:px-20 text-left relative font-sans text-slate-900 overflow-hidden bg-slate-950">
      ...
      />
      <div
        className="absolute -top-40 left-1/2 h-125 w-125 -translate-x-1/2 rounded-full bg-sky-500/10 blur-[120px]"
        aria-hidden="true"
      />
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="w-12 h-12 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center shrink-0 shadow-sm transition-transform duration-300 group-hover:scale-105">
                        <IconComponent
                          className="h-6 w-6 text-white transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:rotate-12 group-hover:scale-110 group-hover:text-sky-400"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 mt-8">
                      ...
                      <button onClick={handleWhyChooseUsClick} className="pt-2 flex items-center gap-2 text-xs font-semibold text-sky-400 cursor-pointer">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs font-semibold text-sky-400 max-h-0 opacity-0 -translate-y-2 overflow-hidden transition-all duration-300 ease-out group-hover:max-h-6 group-hover:opacity-100 group-hover:translate-y-0">
                          {feat.tagline}
                        </p>
