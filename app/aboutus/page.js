...
export const metadata = {
  title: "About Datatreasure | Verified Business Data & Lead Generation",
  description:
    "Discover how Datatreasure helps businesses reach decision-makers with high-accuracy B2B databases, custom human-assisted research, and pan-India coverage.",
  keywords: [
    "Datatreasure",
    "",
    "B2B data provider",
  ...
  openGraph: {
    title: "About Datatreasure | Verified Business Data & Lead Generation",
    description:
      "Data should create opportunities, not work. Learn how Datatreasure delivers structured, accurate, and dependable B2B contact intelligence.",
    url: `${baseUrl}/aboutus`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Datatreasure B2B Data Platform",
      },
    ],
    type: "website",
  },
