...
export default function BlogPostForm({ onSubmit }) {
  ...
  const inputClass = "w-full rounded-xl border border-neutral-200 bg-white px-4 py-2.5 text-sm text-neutral-800 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-800/10 focus:border-neutral-400 transition";
  ...
  return (
    <div className="w-full h-screen bg-cyan-50 overflow-scroll">
    <form
      onSubmit={handleSubmit}
      className="w-full shadow bg-white/5 max-w-3xl mx-auto flex flex-col gap-6 px-6 py-10 pt-28"
    >
